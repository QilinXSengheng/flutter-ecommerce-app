...
class _TCategoryTabState extends State<TCategoryTab> with AutomaticKeepAliveClientMixin {
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              FutureBuilder(
                future: controller.getCategoryProducts(categoryId: widget.category.id),
                    ...
                    children: [
                      TSectionHeading(
                        ...
                        onPressed: () => Get.to(AllProducts(
                          ...
                          future: controller.getCategoryProducts(categoryId: widget.category.id, limit: -1),
                        )),
                      ),
