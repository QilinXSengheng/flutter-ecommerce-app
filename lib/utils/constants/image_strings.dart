...
class TImages {
  ...
  // -- App Logos
  static const String darkAppLogo = "assets/logos/h-store-splash-to-go-white.png";
  static const String lightAppLogo = "assets/logos/h-store-splash-to-go-black.png";
